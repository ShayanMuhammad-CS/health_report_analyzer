...
class ModelManager:
    ...
    Implements an agent-based approach for model management with automatic cascade.
    """
    ...
    def generate_analysis(self, data, system_prompt, retry_count=0) -> dict:
        """
        ...
        tier_map = {
            ...
            2: ModelTier.TERTIARY,
            3: ModelTier.FALLBACK,
        }
        tier = tier_map[retry_count]
        ...
        try:
            ...
            # Wait briefly before retrying with a different model on rate limit
